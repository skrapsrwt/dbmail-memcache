...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	THANKS config/compile config/config.guess config/config.sub \
...
STRIP = strip
VERSION = 3.0.2
abs_builddir = /home/skraps/projects/dbmail-memcache
abs_srcdir = /home/skraps/projects/dbmail-memcache
